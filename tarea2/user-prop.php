								...
								<div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ#() ]{1,400}" value="<?php echo $distrito ?> class="form-control" name="prop_distrito" id="prestamo_pagadon" maxlength="100">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="prestamo_pagado" class="bmd-label-floating">Zona</label>
                                            <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ#() ]{1,400}" value="<?php echo $zona ?> class="form-control" name="prop_zona" id="prestamo_pagadon" maxlength="100">
                                        </div>
                                    </div>
	                                <div class="col-12">
	                                    <div class="form-group">
