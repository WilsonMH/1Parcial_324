...
<head>
	...
	<?php include 'cabecera.php' ?>
		...
		<section class="full-box page-content">
			...
			<!-- Content -->
			<div class="container-fluid">
				<form action="actualizar_user.php" method="GET" class="form-neon" autocomplete="off">
							...
							<div class="row">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" value="<?php echo $nombre ?>" name="nombre" id="usuario_nombre" maxlength="35">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_apellido" class="bmd-label-floating">Paterno</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" value="<?php echo $paterno ?>" name="paterno" id="usuario_apellido" maxlength="35">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_apellido" class="bmd-label-floating">Materno</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" value="<?php echo $materno ?>" name="materno" id="usuario_apellido" maxlength="35">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_dni" class="bmd-label-floating">CI</label>
										<input type="text" pattern="[0-9-]{1,20}" class="form-control" value="<?php echo $usuario_ci ?>" name="usuario_ci" id="usuario_dni" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="usuario_direccion" class="bmd-label-floating">Dirección</label>
										<input type="text" pattern="[a-zA-Z0-99áéíóúÁÉÍÓÚñÑ()# ]{1,190}" class="form-control" value="<?php echo $direccion ?>" name="direccion" id="usuario_direccion" maxlength="190">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" value="<?php echo $user ?>" name="usuario_usuario" id="usuario_usuario" maxlength="35">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
