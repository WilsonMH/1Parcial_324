					...
					<fieldset>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<select class="form-control" name="usuario_distrito" id="distrito">
											...
											<?php
										        ...
										        // Generar las opciones de distrito
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<select class="form-control" name="usuario_zona" id="zona">
											<option value="" selected="" disabled="">Seleccione una opción</option>
	    ...
	    $(document).ready(function() {
	        $('#distrito').on('change', function() {
	            ...
	            if (idDistrito) {
	                ...
	                $('#zona').html('<option value="">Seleccionar zona</option>');
	            }
	        });
	    });
	</script>
